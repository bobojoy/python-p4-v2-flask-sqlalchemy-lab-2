...
class Customer(db.Model, SerializerMixin):
    ...
    # Serialization rules
    serialize_rules = (
        ('reviews', '-customer'),  # Exclude the customer from the serialized reviews
        'items',                   # Include items via association proxy
    )
...
class Item(db.Model, SerializerMixin):
    ...
    # Serialization rules
    serialize_rules = (
        ('reviews', '-item'),  # Exclude the item from the serialized reviews
    )
